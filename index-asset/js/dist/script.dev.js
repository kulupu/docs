...
$(document).ready(function () {
  ...
  var words = ["Proof of Work.", "Based on Substrate.", "On-chain Governance.", "Forkless Upgrades.", "Actor-based Smart Contracts."];
  var i = 0;
  var timer;
  ...
  ;
  typingEffect();
  var _CONTENT = ["Proof of Work.", "Based on Substrate.", "On-chain Governance.", "Forkless Upgrades.", "Actor-based Smart Contracts."]; // Current sentence being processed
  ...
  var _ELEMENT = document.querySelector("#text"); // Cursor element 
  ...
  $.get('https://kulupu-api.herokuapp.com/members', function (response) {
    ...
    response.forEach(function (element, index) {
      var template = "<div style=\"text-align: center; margin-top: 50px;\" class=\"col-sm-3 single-member\" data-aos=\"zoom-in\">\n            ".concat(images[index], "\n            <h5 class=\"council-title\">").concat(element.info.display.Raw, "</h5>\n            <p>").concat(element.info.legal.Raw != null ? "<i class=\"fas fa-user green-logo\"></i> ".concat(element.info.legal.Raw) : "", "</p>\n            <p>").concat(element.info.twitter.Raw != null ? "<i class=\"fab fa-twitter green-logo\"></i> ".concat(element.info.twitter.Raw) : "", "</p>\n            <p>").concat(element.info.email.Raw != null ? "<i class=\"fas fa-envelope-open-text green-logo\"></i> ".concat(element.info.email.Raw) : "", "</p>\n            <p>").concat(element.info.web.Raw != null ? "<i class=\"fas fa-link green-logo\"></i> ".concat(element.info.web.Raw) : "", "</p>\n            <p>").concat(element.info.riot.Raw != null ? "<i class=\"fas fa-comment green-logo\"></i> ".concat(element.info.riot.Raw) : "", "</p>\n            <p class=\"council-description\">2eeTYXTedvyzCaP9sLJ1oExdqHKLHburZR5endQW9VBbShBU</p>\n          </div>");
